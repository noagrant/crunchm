Crunchm::Application.configure do
  ...
  # Do not fallback to assets pipeline if a precompiled asset is missed. ########################## commented out ###########################
  ...
  config.assets.precompile += %w(comparisons.css.scss ie7.css ie8.css styles.css validationEngine.jquery.css)
